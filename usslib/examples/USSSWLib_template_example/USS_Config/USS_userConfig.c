...
#if defined(USS_ENABLE_ABSTOF_LOBE_OFFSET_CORRECTION)
#include <USS_Config/USS_intrplCorrLUT.h>
#endif
#if defined(USS_ENABLE_VFR_METER_CALIB)
#include <USS_Config/USS_meterVFRCalib.h>
#endif
...
#if defined(USS_ENABLE_VFR_METER_CALIB)
#if (USS_ENABLE_VFR_METER_CALIB == true)
...
#if defined(USS_ENABLE_VFR_METER_CALIB)
#if (USS_ENABLE_VFR_METER_CALIB == true)
__persistent USS_Algorithms_Meter_Constant_Calib
       ussAlgorithmMeterConstCalib[USS_VFR_METER_CALIB_RANGES] =
               USS_VFR_METER_CALIB_DATA;
#endif
#endif
...
__no_init int16_t gUSSLEARAMReservedBlock1[USS_SW_LIB_APP_MAX_CAPTURE_SIZE +
                                           USS_SW_LIB_APP_MAX_FILTER_LENGTH];
...
__persistent USS_Algorithms_User_Configuration ussAlgConfig = {
...
#if(USS_ALG_ENABLE_WINDOWING == true)
    ...
    .numOfMeterCalibrationRanges = USS_VFR_METER_CALIB_RANGES,
#else
    .numOfMeterCalibrationRanges = 0,
#endif
#else
    .pMeterConfiguration = NULL,
    .numOfMeterCalibrationRanges = 0,
#endif
