...
#define USS_HSPLL_TOLERANCE_PERCENT            0.1
 ...
 * - USS_measurement_capture_sequence_ch0_ch1 (default)
...
#define USS_HSPLL_TOLERANCE    ((USS_HSPLL_TEMP) * (USS_HSPLL_TOLERANCE_PERCENT))
