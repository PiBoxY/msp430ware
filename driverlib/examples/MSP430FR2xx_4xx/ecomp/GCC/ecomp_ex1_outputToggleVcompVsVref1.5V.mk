...
DEVICE:=MSP430FR2311
EXAMPLE:=ecomp_ex1_outputToggleVcompVsVref1.5V
...
INCLUDES         := -I $(GCC_MSP_INC_DIR) -I $(GCC_INC_DIR) -I ../../../../driverlib/MSP430FR2xx_4xx -I ../..
######################################
DRIVERLIB_SRC    := $(wildcard ../../../../driverlib/MSP430FR2xx_4xx/*.c)
