...
hid_device * HID_API_EXPORT hid_open_path(const char *path)
{
	...
	if (good_open) {
        // Instead of returning the handle we return the index into the devHandles arra.
        // This is because JAVA only wants to store the handles as a 4byte int instead
