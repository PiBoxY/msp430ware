...
//  voltage divider provides Vcc/2 to the input pin (P9.1/C9). When Vcc/2 drops
...
//           ---------------
//       /|\|           P9.0|---> Vcc
//        | |       (C9)P9.1|---> Vcc/2 (350k/350k voltage divider)
//        --|RST        P9.5|---> GND
//          |               |
//          |           P1.0|---> LED1
//          |               |
...
void initCompMonitor(void)
{
    /* Set P9.0 to Vcc and P9.5 to GND. */
    P9OUT |= BIT0;
    P9OUT &= ~BIT5;

    /* Setup COMP_E for P9.1 (C9) input with 1.5v reference. */
    CECTL0 = CEIPEN | CEIPSEL_9;
