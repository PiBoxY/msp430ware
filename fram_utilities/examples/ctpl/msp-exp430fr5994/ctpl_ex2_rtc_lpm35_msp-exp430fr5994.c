...
//  example will toggle P1.1 after initialization to indicate a device start up
...
#error "Device does not wake up in LPM3.5 with RTC_C interrupt, see errata PMM25."
...
int main(void)
{
    ...
    /* Toggle P1.1 LED to indicated device start up. */
    P1OUT ^= BIT1;
