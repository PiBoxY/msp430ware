...
#ifndef __MSP430FR60471__
#error This file is only to be used with msp430fr60471, please replace this and the linker files with the correct device files.
#endif
...
__persistent
#endif
uint16_t ctpl_TA4_storage[CTPL_TIMER_2_STORAGE_LENGTH] = {0};

const ctpl_peripheral ctpl_TA4 = {
    __MSP430_BASEADDRESS_T4A2__,
    ctpl_TA4_storage,
    ctpl_TIMER_2_save,
    ctpl_TIMER_2_restore,
    ctpl_TIMER_2_epilogue
...
#ifdef CTPL_SAVE_LCD_C

#if defined(__TI_COMPILER_VERSION__)
#pragma PERSISTENT(ctpl_LCD_C_storage)
#elif defined(__IAR_SYSTEMS_ICC__)
__persistent
#endif
uint16_t ctpl_LCD_C_storage[CTPL_LCD_C_STORAGE_LENGTH] = {0};

const ctpl_peripheral ctpl_LCD_C = {
    __MSP430_BASEADDRESS_LCD_C__,
    ctpl_LCD_C_storage,
    ctpl_LCD_C_save,
    ctpl_LCD_C_restore,
    ctpl_LCD_C_epilogue
