...
#ifndef __MSP430FR4131__
#error This file is only to be used with msp430fr4131, please replace this and the linker files with the correct device files.
#endif
...
#ifdef CTPL_SAVE_LCD_E

#if defined(__TI_COMPILER_VERSION__)
#pragma PERSISTENT(ctpl_LCD_E_storage)
#elif defined(__IAR_SYSTEMS_ICC__)
__persistent
#endif
uint16_t ctpl_LCD_E_storage[CTPL_LCD_E_STORAGE_LENGTH] = {0};

const ctpl_peripheral ctpl_LCD_E = {
    __MSP430_BASEADDRESS_LCD_E__,
    ctpl_LCD_E_storage,
    ctpl_LCD_E_save,
    ctpl_LCD_E_restore,
    ctpl_LCD_E_epilogue
