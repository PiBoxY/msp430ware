...
#ifndef __MSP430FR59941__
#error This file is only to be used with msp430fr59941, please replace this and the linker files with the correct device files.
#endif
...
//#define CTPL_SAVE_EUSCIA2
//#define CTPL_SAVE_EUSCIA3
...
const ctpl_peripheral ctpl_FRAM = {
    __MSP430_BASEADDRESS_FRCTL_A__,
    ctpl_FRAM_storage,
    ctpl_FRAM_save,
    ctpl_FRAM_restore,
    ctpl_FRAM_epilogue
...
#if defined(__TI_COMPILER_VERSION__)
#pragma PERSISTENT(ctpl_TA4_storage)
#elif defined(__IAR_SYSTEMS_ICC__)
__persistent
#endif
uint16_t ctpl_TA4_storage[CTPL_TIMER_3_STORAGE_LENGTH] = {0};

const ctpl_peripheral ctpl_TA4 = {
    __MSP430_BASEADDRESS_T4A3__,
    ctpl_TA4_storage,
    ctpl_TIMER_3_save,
    ctpl_TIMER_3_restore,
    ctpl_TIMER_3_epilogue
...
#ifdef CTPL_SAVE_EUSCIA2

#if defined(__TI_COMPILER_VERSION__)
#pragma PERSISTENT(ctpl_EUSCIA2_storage)
#elif defined(__IAR_SYSTEMS_ICC__)
__persistent
#endif
uint16_t ctpl_EUSCIA2_storage[CTPL_EUSCI_A_STORAGE_LENGTH] = {0};

const ctpl_peripheral ctpl_EUSCIA2 = {
    __MSP430_BASEADDRESS_EUSCI_A2__,
    ctpl_EUSCIA2_storage,
    ctpl_EUSCI_A_save,
    ctpl_EUSCI_A_restore,
    ctpl_EUSCI_A_epilogue
};
...
#ifdef CTPL_SAVE_EUSCIA3

#if defined(__TI_COMPILER_VERSION__)
#pragma PERSISTENT(ctpl_EUSCIA3_storage)
#elif defined(__IAR_SYSTEMS_ICC__)
__persistent
#endif
uint16_t ctpl_EUSCIA3_storage[CTPL_EUSCI_A_STORAGE_LENGTH] = {0};

const ctpl_peripheral ctpl_EUSCIA3 = {
    __MSP430_BASEADDRESS_EUSCI_A3__,
    ctpl_EUSCIA3_storage,
    ctpl_EUSCI_A_save,
    ctpl_EUSCI_A_restore,
    ctpl_EUSCI_A_epilogue
};
...
#ifdef CTPL_SAVE_EUSCIB2

#if defined(__TI_COMPILER_VERSION__)
#pragma PERSISTENT(ctpl_EUSCIB2_storage)
#elif defined(__IAR_SYSTEMS_ICC__)
__persistent
#endif
uint16_t ctpl_EUSCIB2_storage[CTPL_EUSCI_B_STORAGE_LENGTH] = {0};

const ctpl_peripheral ctpl_EUSCIB2 = {
    __MSP430_BASEADDRESS_EUSCI_B2__,
    ctpl_EUSCIB2_storage,
    ctpl_EUSCI_B_save,
    ctpl_EUSCI_B_restore,
    ctpl_EUSCI_B_epilogue
};
...
#ifdef CTPL_SAVE_EUSCIB3

#if defined(__TI_COMPILER_VERSION__)
#pragma PERSISTENT(ctpl_EUSCIB3_storage)
#elif defined(__IAR_SYSTEMS_ICC__)
__persistent
#endif
uint16_t ctpl_EUSCIB3_storage[CTPL_EUSCI_B_STORAGE_LENGTH] = {0};

const ctpl_peripheral ctpl_EUSCIB3 = {
    __MSP430_BASEADDRESS_EUSCI_B3__,
    ctpl_EUSCIB3_storage,
    ctpl_EUSCI_B_save,
    ctpl_EUSCI_B_restore,
    ctpl_EUSCI_B_epilogue
};
...
__persistent
#endif
uint16_t ctpl_DMA_storage[CTPL_DMAX_6_STORAGE_LENGTH] = {0};

const ctpl_peripheral ctpl_DMA = {
    __MSP430_BASEADDRESS_DMA__,
    ctpl_DMA_storage,
    ctpl_DMAX_6_save,
    ctpl_DMAX_6_restore,
    ctpl_DMAX_6_epilogue
};
#endif
