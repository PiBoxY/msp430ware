...
function getFamilyPath(deviceName)
{
    ...
    if (deviceName.match(/^MSP430(F)(5|6)/i)) {
        family = "driverlib/MSP430F5xx_6xx";
    }
    else if (deviceName.match(/^MSP430FR57/i)) {
        family = "driverlib/MSP430FR57xx";
    }
    else if (deviceName.match(/^MSP430FR5(9|8)/i)) {
        family = "driverlib/MSP430FR5xx_6xx";
    }
