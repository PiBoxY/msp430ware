/* --COPYRIGHT--,TI
 *  MSP430 Tools Source and Object Code Software License Agreement 
 *  
 *  
...
//  Feb 2008
//  Built with IAR Embedded Workbench Version: X.XX
//******************************************************************************
/*******************************************************************************
Change Log:
--------------------------------------------------------------------------------
Version 3.1 (no output change, source/comment modified)
06.05.10 LCW Abstracted Timer Defines for portability
--------------------------------------------------------------------------------
Version 4.0
22.06.10 LCW Changed output mode for 5329 Timer_A
23.07.10 LCW Changed buffer size to unsigned to prevent infinite looping
*******************************************************************************/
...
#pragma NOINIT(BitTime);
unsigned int BitTime;
#pragma NOINIT(BitTime_5);
unsigned int BitTime_5;

#pragma NOINIT(BSL430_ReceiveBuffer);
...
#pragma DATA_SECTION(BSL430_PI_Version, ".BSL430_VERSION_PI");
const unsigned char BSL430_PI_Version = (BSL430_TIMER_A_PI+TIMER_A_VERSION);
#pragma RETAIN(BSL430_PI_Version);
/*******************************************************************************
*Function:    PI_init
