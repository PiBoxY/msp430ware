...
*  08.03.1 LCW  Increased MCLK to 8MHz
*  -----------------------------------------------------------------------------
*  Version 4 work begins
*  13.02.13 LCW  incorrect packet size now clears buffer, fixing: BUG0000076477, BUG0000076667 
*  04.03.13 LCW  TX buffer overflow fixed: BUG0000076758
*******************************************************************************/
...
#pragma DATA_ALIGN(RAM_TX_Buf, 2);
char RAM_TX_Buf[MAX_BUFFER_SIZE+6];   //+6 to accomidate send buffer of max size plus packet bytes (ack, 0x80, size, size, [packet], CRC, CRC) BUG0000076758
#pragma DATA_ALIGN(RAM_RX_Buf, 2);
