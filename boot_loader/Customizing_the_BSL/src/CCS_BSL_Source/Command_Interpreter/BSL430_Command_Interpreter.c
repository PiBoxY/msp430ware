...
#pragma DATA_SECTION(BSL430_Vendor_Version, ".BSL430_VERSION_VENDOR");
const unsigned char BSL430_Vendor_Version = 0x00;
#pragma DATA_SECTION(BSL430_CI_Version, ".BSL430_VERSION_CI");
...
*             incoming packets
*******************************************************************************/
#pragma RETAIN(BSL430_Vendor_Version);
#pragma RETAIN(BSL430_CI_Version);
void main(void)
{
