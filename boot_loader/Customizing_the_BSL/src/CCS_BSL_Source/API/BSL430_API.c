...
#endif
#pragma DATA_SECTION(BSL430_API_Version, ".BSL430_VERSION_API");
const unsigned char BSL430_API_Version = API_V;
#pragma RETAIN(BSL430_API_Version);

// Data section to have the JTAG key in the BSL area @17FCh-17FFh
// 0xFFFFFFFF and 0x00000000 to unlock the JTAG/SBW , 
// and other values to lock JTAG/SBW 
