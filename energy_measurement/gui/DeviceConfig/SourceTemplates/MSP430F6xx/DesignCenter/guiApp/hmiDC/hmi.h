...
typedef enum _HMI_STATE_t_		// Defines the state of the HMI
{                               //
    HMI_STATE_IDLE = 0,         // No commands are transmitted to the host
    HMI_STATE_ACTIVE,           // EM Results will be transmitted to the host
    HMI_STATE_CALIBRATE,        // EM Calibration mode
}HMI_STATE_t;
...
//!         and will send phase results based on the HMI state
//!
//! \return none
