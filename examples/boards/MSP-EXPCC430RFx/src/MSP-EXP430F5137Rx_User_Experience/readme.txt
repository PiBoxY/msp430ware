MSP-EXP430F5137Rx Experimenter's Board User Experience Demo v1.0.0.0
...
|--CCS                        : Folder containing the CCSv4 project files
   |--lnk_msp430f5137.cmd     : Device linker command file   
...
|--MSP-EXP430F5137_HAL        : Folder containing board-level HAL
...
|--MspExp430F5137RxUserExperience.c                 : Main User Experience file
|--MSP-EXP430F5137Rx User Experience Manifest.pdf   : Software manifest