MSP-EXP430G2ET Software Examples v1.01.00
Texas Instruments, Inc.


********************************************************************************
Welcome to the MSP-EXP430G2ET LaunchPad!
********************************************************************************
...
The software example projects are located in the 'Source' folder:
 1. BlinkLED_MSP-EXP430G2ET                | Blink LED example
 3. BOOSTXL-SHARP128_GrlibExample_MSP-EXP430G2ET | Sharp128 Display Example
 2. OutOfBox_MSP-EXP430G2ET                | The out of box demo source code
...
For more resources, be sure to visit www.ti.com/tool/msp-exp430G2ET


********************************************************************************
Revision History
********************************************************************************
Ver 1.01.00 - Sept 15, 2018
- Added BOOSTXL-SHARP128 Display example

Ver 1.00.00 - May 15, 2018
- Initial Release of Rev1.0 PCB
...
|--Firmware                           : Folder containing example firmwares
   ...
   |--Source                          : Folder containing software examples
      |--BlinkLED_MSP-EXP430G2ET      : Blink LED example
      |--BOOSTXL-SHARP128_GrlibExample_MSP-EXP430G2ET : Sharp128 Display example
      |--OutOfBox_MSP-EXP430G2ET      : Out of box demo source code
