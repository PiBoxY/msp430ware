...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fprocessing%2Fsource%2Fbrowse%2Ftrunk%2Fprocessing%2Fcore%2Fsrc%2Fprocessing%2Fcore%2FPStyle.java" 
...
<table id="nav_and_rev" class="list"
 ...
 <a href="/p/processing/source/browse/trunk/processing/core/src/processing/core/PStyle.java?edit=1"
 ...
 <li><a href="/p/processing/source/browse/trunk/processing/core/src/processing/core/PStyle.java?r=4689" title="Previous">&lsaquo;r4689</a></li>
...
><td class="source">  Copyright (c) 2008 Ben Fry and Casey Reas<br></td></tr
><tr
id=sl_svn7768_7
...
><td class="source">public class PStyle implements PConstants {<br></td></tr
><tr
id=sl_svn7768_28

><td class="source">  public int imageMode;<br></td></tr
><tr
id=sl_svn7768_29

><td class="source">  public int rectMode;<br></td></tr
><tr
id=sl_svn7768_30

><td class="source">  public int ellipseMode;<br></td></tr
><tr
id=sl_svn7768_31

><td class="source">  public int shapeMode;<br></td></tr
><tr
id=sl_svn7768_32
...
><td class="source">  public int colorMode;<br></td></tr
><tr
id=sl_svn7768_34

><td class="source">  public float colorModeX;<br></td></tr
><tr
id=sl_svn7768_35

><td class="source">  public float colorModeY;<br></td></tr
><tr
id=sl_svn7768_36

><td class="source">  public float colorModeZ;<br></td></tr
><tr
id=sl_svn7768_37

><td class="source">  public float colorModeA;<br></td></tr
><tr
id=sl_svn7768_38
...
><td class="source">  public boolean tint;<br></td></tr
><tr
id=sl_svn7768_40

><td class="source">  public int tintColor;<br></td></tr
><tr
id=sl_svn7768_41

><td class="source">  public boolean fill;<br></td></tr
><tr
id=sl_svn7768_42

><td class="source">  public int fillColor;<br></td></tr
><tr
id=sl_svn7768_43

><td class="source">  public boolean stroke;<br></td></tr
><tr
id=sl_svn7768_44

><td class="source">  public int strokeColor;<br></td></tr
><tr
id=sl_svn7768_45

><td class="source">  public float strokeWeight;<br></td></tr
><tr
id=sl_svn7768_46

><td class="source">  public int strokeCap;<br></td></tr
><tr
id=sl_svn7768_47

><td class="source">  public int strokeJoin;<br></td></tr
><tr
id=sl_svn7768_48
...
><td class="source">  // TODO these fellas are inconsistent, and may need to go elsewhere<br></td></tr
><tr
id=sl_svn7768_50

><td class="source">  public float ambientR, ambientG, ambientB;<br></td></tr
><tr
id=sl_svn7768_51

><td class="source">  public float specularR, specularG, specularB;<br></td></tr
><tr
id=sl_svn7768_52

><td class="source">  public float emissiveR, emissiveG, emissiveB;<br></td></tr
><tr
id=sl_svn7768_53

><td class="source">  public float shininess;<br></td></tr
><tr
id=sl_svn7768_54
...
><td class="source">  public PFont textFont;<br></td></tr
><tr
id=sl_svn7768_56

><td class="source">  public int textAlign;<br></td></tr
><tr
id=sl_svn7768_57

><td class="source">  public int textAlignY;<br></td></tr
><tr
id=sl_svn7768_58

><td class="source">  public int textMode;<br></td></tr
><tr
id=sl_svn7768_59

><td class="source">  public float textSize;<br></td></tr
><tr
id=sl_svn7768_60

><td class="source">  public float textLeading;<br></td></tr
><tr
id=sl_svn7768_61
...
<script type="text/javascript">
 ...
 <p>Change log</p>
 <div>
 <a href="/p/processing/source/detail?spec=svn7768&r=4696">r4696</a>
 by fry
 on Sep 29, 2008
 &nbsp; <a href="/p/processing/source/diff?spec=svn7768&r=4696&amp;format=side&amp;path=/trunk/processing/core/src/processing/core/PStyle.java&amp;old_path=/trunk/processing/core/src/processing/core/PStyle.java&amp;old=4689">Diff</a>
 </div>
 <pre>major pmatrix work, still in progress,
lots of errors
</pre>
 </div>
 ...
 <script type="text/javascript">
 var detail_url = '/p/processing/source/detail?r=4696&spec=svn7768';
 var publish_url = '/p/processing/source/detail?r=4696&spec=svn7768#publish';
 // describe the paths of this revision in javascript.
 var changed_paths = [];
 var changed_urls = [];
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PApplet.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PApplet.java?r\x3d4696\x26spec\x3dsvn7768');
 
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PGraphics.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PGraphics.java?r\x3d4696\x26spec\x3dsvn7768');
 
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PGraphics2D.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PGraphics2D.java?r\x3d4696\x26spec\x3dsvn7768');
 
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PGraphics3D.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PGraphics3D.java?r\x3d4696\x26spec\x3dsvn7768');
 
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PGraphicsJava2D.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PGraphicsJava2D.java?r\x3d4696\x26spec\x3dsvn7768');
 
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PMatrix.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PMatrix.java?r\x3d4696\x26spec\x3dsvn7768');
 
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PMatrix2D.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PMatrix2D.java?r\x3d4696\x26spec\x3dsvn7768');
 
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PMatrix3D.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PMatrix3D.java?r\x3d4696\x26spec\x3dsvn7768');
 
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PStyle.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PStyle.java?r\x3d4696\x26spec\x3dsvn7768');
 
 var selected_path = '/trunk/processing/core/src/processing/core/PStyle.java';
 ...
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PApplet.java?r=4696&amp;spec=svn7768"
 
 >...src/processing/core/PApplet.java</option>
 
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PGraphics.java?r=4696&amp;spec=svn7768"
 
 >...c/processing/core/PGraphics.java</option>
 
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PGraphics2D.java?r=4696&amp;spec=svn7768"
 
 >...processing/core/PGraphics2D.java</option>
 
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PGraphics3D.java?r=4696&amp;spec=svn7768"
 
 >...processing/core/PGraphics3D.java</option>
 
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PGraphicsJava2D.java?r=4696&amp;spec=svn7768"
 
 >...essing/core/PGraphicsJava2D.java</option>
 
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PMatrix.java?r=4696&amp;spec=svn7768"
 
 >...src/processing/core/PMatrix.java</option>
 
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PMatrix2D.java?r=4696&amp;spec=svn7768"
 
 >...c/processing/core/PMatrix2D.java</option>
 
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PMatrix3D.java?r=4696&amp;spec=svn7768"
 
 >...c/processing/core/PMatrix3D.java</option>
 
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PStyle.java?r=4696&amp;spec=svn7768"
 selected="selected"
 >.../src/processing/core/PStyle.java</option>
 ...
 <a href="/p/processing/source/detail?spec=svn7768&r=4689">r4689</a>
 by fry
 on Sep 28, 2008
 &nbsp; <a href="/p/processing/source/diff?spec=svn7768&r=4689&amp;format=side&amp;path=/trunk/processing/core/src/processing/core/PStyle.java&amp;old_path=/trunk/processing/core/src/processing/core/PStyle.java&amp;old=0">Diff</a>
 <br>
 <pre class="ifOpened">dealing with PStyle changes
</pre>
 </div>
 
 
 <a href="/p/processing/source/list?path=/trunk/processing/core/src/processing/core/PStyle.java&start=4696">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="http://processing.googlecode.com/svn/trunk/processing/core/src/processing/core/PStyle.java">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn7768': '/trunk/processing/core/src/processing/core/PStyle.java'}
