...
//    RAM                     : origin = 0x1C00, length = 0x4000
    ...
    RESERVED_FOR_POWER_TEST : origin = 0x2000, length = 0x0022
    RAM2                    : origin = 0x2022, length = 0x3BDE
...
SECTIONS
{
    ...
    .sysmem    : {} > RAM | RAM2         /* DYNAMIC MEMORY ALLOCATION AREA    */
    .stack     : {} > RAM2 (HIGH)  		 /* SOFTWARE SYSTEM STACK             */

/* Note: The FLASH2 region has been excluded from both .text and .const       */
/* as it is used by the firmware's voice recorder.							  */
