...
- Some modifications where required to the original source code. All these changes have been marked with [BM].
	...
	smartrf_CC430.h                         Added in ISM_US configuration Base Frequency for Chronos with Black PCB
	...
	mrfi_radio.c							Changed channel assignment (mrfiLogicalChanTable) for three ISM bands
											...
											Updated to support differences in RF settings between Chronos
											with Black PCB and Chronos with White PCB
