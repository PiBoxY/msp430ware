	...
	function createNewWinstonLogger()
	{
		...
		({
			...
			[
				...
				new (winston.transports.File)({ level: 'tracefinest', filename: mainLog,name: 'file.all' , handleExceptions: handleUncaughtExceptions, json: fileLoggerJson, humanReadableUnhandledException: true} ) 
			]
		});
