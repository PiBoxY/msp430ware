...
function install (gyp, argv, callback) {
  ...
  var distUrl = gyp.opts['dist-url'] || gyp.opts.disturl || 'http://node-webkit.s3.amazonaws.com'
  ...
  if (semver.lt(versionStr, '0.3.2')) {
    return callback(new Error('Minimum target version is `0.3.2` or greater. Got: ' + versionStr))
  }
  ...
  function go () {
    ...
    mkdir(devDir, function (err, created) {
      ...
      var tarballUrl = tarPath ? tarPath : distUrl + '/v' + version + '/nw-headers-v' + version + '.tar.gz'
        , badDownload = false
        , extractCount = 0
      ...
      function downloadNodeLib (done) {
        ...
        var dir32 = path.resolve(devDir, 'ia32')
          ...
          , nodeLibPath32 = path.resolve(dir32, 'nw.lib')
          , nodeLibPath64 = path.resolve(dir64, 'nw.lib')
          , nodeLibUrl32 = distUrl + '/v' + version + '/nw.lib'
          , nodeLibUrl64 = distUrl + '/v' + version + '/x64/nw.lib'
