...
var getUserHome = exports.getUserHome  = function() 
{
  ...
  * =============================================== */
var tiDirectoryHome;
exports.getTiDirectory  = function() 
{
	if(!tiDirectoryHome)
	{
		tiDirectoryHome = getUserHome()	 + "/ti/";
	}

  return tiDirectoryHome;
}
...
{	
  ...
  * =============================================== */
var localAppDataDirectory;
exports.getLocalAppDataDirectory  = function()
{	
...
exports.getUserTempDirectory  = function()
{	
	if(!userTempDirectory)
	{
		userTempDirectory=process.env.TEMP; //TMP
	}
...
{	
	if(!userName)
	{
		userName=process.env.LOGNAME; //USERNAME
	}
