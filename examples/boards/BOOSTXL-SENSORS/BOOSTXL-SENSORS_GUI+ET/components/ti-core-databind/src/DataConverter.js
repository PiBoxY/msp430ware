...
(function()  
{
	...
	var converters = 
	{
		...
		"boolean" : { any : { convert: function(input) { return !!input; } } },
	 ...
	 */
	gc.databind.DataConverter.convert = function(data, srcType, destType)
	{
		...
		return this.getConverter(srcType, destType).convert(data);
	};
