...
(function()
{
    ...
    WidgetBindValue.prototype.onValueChanged = function(oldValue, newValue, progress)
    {
        ...
        if (this._observer === undefined)
        {
            ...
            var widget = document.querySelector('#' + this.widgetId);
            if (widget)
            {
    ...
    {
        this._widget = this._widget || document.querySelector('#' + this.widgetId);
        return this._widget;
    };
    ...
    WidgetBindValue.prototype.onStatusChanged = function(oldStatus, newStatus)
    {
        ...
        {
            gc.widget.StatusIndicator.Factory.get(this.getWidget()).removeMessage(oldStatus.getMessage());
        }
    };
    ...
    WidgetBindValue.prototype.onFirstValueChangedListenerAdded = function()
    {
        ...
        if (widget)
        {
            ...
            {
                bind.onDataReceived = streamingListener.bind(widget);
            }
