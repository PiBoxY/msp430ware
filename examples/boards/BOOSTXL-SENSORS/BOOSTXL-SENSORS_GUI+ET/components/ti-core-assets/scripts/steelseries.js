...
SteelSeries.prototype = {
    ...
    initSteelSeries: function(parameters){
        ...
        console.log('BackgroundColor.BRUSHED_STAINLESS = '+this.BackgroundColor.BRUSHED_STAINLESS);
        ...
        console.log('this.gaugeType = '+this.gaugeType.type);
        ...
        console.log('InitSteelSeries: parameters.skin  = '+parameters.skin);
        ...
        console.log('InitSteelSeries: backgroundColor.name = '+this.backgroundColor.name);
        console.log('InitSteelSeries: backgroundColor.labelColor = '+this.backgroundColor.labelColor);
...
//            ctx.closePath();
    ...
    init: function(options) {
         ...
         */
        //BC
        console.log('about to call initSteelSeries...');
        this.initSteelSeries(options || {});
        console.log('this.backgroundColor.name = '+this.backgroundColor.name);
        console.log('this.backgroundColor.labelColor = '+this.backgroundColor.labelColor);

        //this.drawRadialBackgroundImage(this.ctx, this.backgroundColor, this.centerX, this.centerY, this.imageWidth, this.imageHeight);
        console.log('about to call initImage...');
        ...
        this.initImage({frame: true,
            ...
            foreground: true,
            odo: false});
        console.log('call to initImage complete.');
        return this;
    },
    ...
    drawRadialFrameImage: function (ctx, frameDesign, centerX, centerY, imageWidthOrig, imageHeightOrig) {
        ...
        // check if we have already created and cached this buffer, if not create it
        console.log('in drawRadialFrameImage function.  cacheKey = '+cacheKey+', drawRadialFrameImage_cache[cacheKey] = '+(drawRadialFrameImage_cache[cacheKey] !== undefined));
...
//BC doesn't work:                 radFCtx.clip(radFCtx.arc(centerX, centerY, imageWidth * 0.990654 / 2, 0, TWO_PI, true));
    ...
    setValue: function (newValue) {
        //console.log('.setValue - newValue = '+newValue+', this.value = '+this.value);
        ...
        if (this.value !== targetValue) {
             ...
             */
            //console.log('ti-core-analoggauge.setValue('+this.value+') about to call repaint.');
            this.repaint();
        }
        return this;
    },
...
// BC: original clock functions [...
    ...
    repaint: function () {
        if (this.initialized) {
            ...
            //console.log('repaint angle = '+this.angle+', value='+this.value+', angleStep='+this.angleStep+' skin ='+this.backgroundColor.name);
