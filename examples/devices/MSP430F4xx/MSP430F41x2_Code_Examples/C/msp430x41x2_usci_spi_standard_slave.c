//******************************************************************************
//   MSP430x41x2 Demo - USCI_A0, SPI 3-Wire Slave multiple byte RX/TX
//
...
//             |  |                 |
//             ---|RST          P6.6|<- Data In (UCA0SIMO)
//                |                 |
//                |             P6.5|-> Data Out (UCA0SOMI)
//            ----|XIN              |
//          32kHz |             P6.3|<- Serial Clock In (UCA0CLK)
//            ----|XOUT             |
//                |             P6.4|<- Master's GPIO (Chip Select)
//
