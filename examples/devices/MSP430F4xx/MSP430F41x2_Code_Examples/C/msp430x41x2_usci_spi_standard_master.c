//******************************************************************************
//   MSP430x41x2 Demo - USCI_A0, SPI 3-Wire Master multiple byte RX/TX
//
...
//        /|\ /|\ |             P5.3|-> Comms LED
//         |   |  |                 |
//         |   ---|RST          P6.2|-> Slave Reset (GPIO)
//        10k     |                 |
//         |      |             P6.6|-> Data Out (UCA0SIMO)
// Button--+----->|P1.3             |
//   Button LED <-|P5.1         P6.5|<- Data In (UCA0SOMI)
//                |                 |
//            ----|XIN          P6.3|-> Serial Clock Out (UCA0CLK)
//          32kHz |                 |
//            ----|XOUT         P6.4|-> Slave Chip Select (GPIO)
//
