//******************************************************************************
//   MSP430x47x Demo - USCI_A0, SPI 3-Wire Master multiple byte RX/TX
//
...
//       Button ->|P1.3             |
//   Button LED <-|P4.6         P2.5|<- Data In (UCA0SOMI)
//                |                 |
...
#define BUTTON_LED_OUT  P4OUT
#define BUTTON_LED_DIR  P4DIR
#define BUTTON_LED_PIN  BIT6

#define COMMS_LED_OUT   P4OUT
#define COMMS_LED_DIR   P4DIR
