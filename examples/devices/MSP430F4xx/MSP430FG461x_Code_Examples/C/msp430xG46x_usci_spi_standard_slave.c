//******************************************************************************
//   MSP430xG461x Demo - USCI_A0, SPI 3-Wire Slave multiple byte RX/TX
//
...
//             |  |                 |
//             ---|RST          P7.1|<- Data In (UCA0SIMO)
//                |                 |
//                |             P7.2|-> Data Out (UCA0SOMI)
//            ----|XIN              |
//          32kHz |             P7.3|<- Serial Clock In (UCA0CLK)
//            ----|XOUT             |
//                |             P7.0|<- Master's GPIO (Chip Select)
//
