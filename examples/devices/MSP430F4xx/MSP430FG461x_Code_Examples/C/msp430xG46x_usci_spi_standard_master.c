//******************************************************************************
//   MSP430xG461x Demo - USCI_A0, SPI 3-Wire Master multiple byte RX/TX
//
...
//       Button ->|P1.3             |
//   Button LED <-|P5.1         P7.2|<- Data In (UCA0SOMI)
//                |                 |
//            ----|XIN          P7.3|-> Serial Clock Out (UCA0CLK)
//          32kHz |                 |
//            ----|XOUT         P7.0|-> Slave Chip Select (GPIO)
//
