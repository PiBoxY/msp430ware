//******************************************************************************
//   MSP430FR599x Demo - eUSCI_B1, SPI 4-Wire Slave multiple byte RX/TX
//
...
//             |  |                 |
//             ---|RST          P5.0|<- Data In (UCB1SIMO)
//                |                 |
//                |             P5.1|-> Data Out (UCB1SOMI)
//                |                 |
//                |             P5.2|<- Serial Clock In (UCB1CLK)
//                |                 |
//                |             P5.3|<- Master's GPIO (UCB1STE)
//
...
void initSPI()
{
    ...
    UCB1CTLW0 |= UCCKPL | UCMSB | UCSYNC | UCMODE_2;    // 4-pin, 8-bit SPI Slave
    UCB1CTLW0 &= ~UCSWRST;                     // **Initialize USCI state machine**
    UCB1IFG &= ~(UCTXIFG | UCRXIFG);           // clear pending interrupt flags
