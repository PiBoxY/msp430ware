//******************************************************************************
//   MSP430FR413x Demo - eUSCI_B0, SPI 4-Wire Slave multiple byte RX/TX
//
...
//             |  |                 |
//             ---|RST          P5.2|<- Data In (UCB0SIMO)
//                |                 |
//                |             P5.3|-> Data Out (UCB0SOMI)
//                |                 |
//                |             P5.1|<- Serial Clock In (UCB0CLK)
//                |                 |
//                |             P5.0|<- Master's GPIO (UCB0STE)
//
...
{
    //LEDs
    LED_OUT &= ~(LED0_PIN | LED1_PIN | LED2_PIN); // P1 setup for LED & reset output
    LED_DIR |= (LED0_PIN | LED1_PIN | LED2_PIN);
