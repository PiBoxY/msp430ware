//******************************************************************************
//   MSP430F525x Demo - USCI_A0, SPI 3-Wire Master multiple byte RX/TX
//
...
//            /|\ |             P6.1|-> Comms LED
//             |  |                 |
//             ---|RST          P6.3|-> Slave Reset (GPIO)
//                |                 |
//                |             P3.3|-> Data Out (UCA0SIMO)
//                |                 |
//       Button ->|P6.2         P3.4|<- Data In (UCA0SOMI)
//   Button LED <-|P6.0             |
//                |             P2.7|-> Serial Clock Out (UCA0CLK)
//                |                 |
//                |             P3.2|-> Slave Chip Select (GPIO)
//
...
#define BUTTON_DIR      P6DIR
#define BUTTON_OUT      P6OUT
#define BUTTON_REN      P6REN
#define BUTTON_PIN      BIT2
#define BUTTON_IES      P6IES
#define BUTTON_IE       P6IE
#define BUTTON_IFG      P6IFG
#define BUTTON_VECTOR   PORT6_VECTOR

#define BUTTON_LED_OUT  P6OUT
#define BUTTON_LED_DIR  P6DIR
...
int main(void) {
    ...
    __delay_cycles(200000);                 // Wait for slave to initialize
