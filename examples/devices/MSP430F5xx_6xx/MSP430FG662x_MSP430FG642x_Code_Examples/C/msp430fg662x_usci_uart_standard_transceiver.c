//******************************************************************************
//   MSP430FG662x Demo - USCI_A0, UART Echo received character
...
void initUART()
{
    ...
    // Baud Rate Settings
    // Use Table 36-4 in Family User Guide
    UCA0BRW = 138;
...
void initGPIO()
{
    ...
    P2SEL |= BIT0 | BIT1;               // Assign P2.0 to UCA0TXD and...
    P2DIR |= BIT0 | BIT1;               // P2.1 to UCA0RXD
