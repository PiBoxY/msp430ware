//******************************************************************************
//   MSP430FG662x Demo - USCI_A0, SPI 3-Wire Master multiple byte RX/TX
//
...
//            /|\ |             P8.0|-> Comms LED
//             |  |                 |
//             ---|RST          P2.3|-> Slave Chip Select (GPIO)
//                |                 |
//                |             P1.5|-> Slave Reset (GPIO)
//                |                 |
//       Button ->|P1.6         P2.2|-> Data Out (UCA0SIMO)
//   Button LED <-|P1.0             |
...
#define COMMS_LED_OUT   P8OUT
#define COMMS_LED_DIR   P8DIR
