//******************************************************************************
//   MSP430F524x Demo - USCI_B0, SPI 3-Wire Slave multiple byte RX/TX
//
...
//                   MSP430F5249
//                 -----------------
//            /|\ |             P1.6|<- Master's GPIO (Chip Select)
//             |  |                 |
//             ---|RST          RST |<- Master's GPIO (To reset slave)
//                |                 |
//                |             P1.4|<- Data In (UCB0SIMO)
//                |                 |
//                |             P1.5|-> Data Out (UCB0SOMI)
//                |                 |
//                |             P1.3|<- Serial Clock In (UCB0CLK)
//
