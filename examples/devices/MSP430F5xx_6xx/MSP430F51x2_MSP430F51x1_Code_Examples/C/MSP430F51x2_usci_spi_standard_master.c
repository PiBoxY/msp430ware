//******************************************************************************
//   MSP430F51x2 Demo - USCI_B0, SPI 3-Wire Master multiple byte RX/TX
//
...
//            /|\ |             P1.1|-> Comms LED
//             |  |                 |
//             ---|RST          P1.7|-> Slave Reset (GPIO)
//                |                 |
//                |             P1.4|-> Data Out (UCB0SIMO)
//                |                 |
//       Button ->|P1.2         P1.5|<- Data In (UCB0SOMI)
//   Button LED <-|P1.0             |
//                |             P1.3|-> Serial Clock Out (UCB0CLK)
//                |                 |
//                |             P1.6|-> Slave Chip Select (GPIO)
//
...
void initGPIO()
{
    ...
    // Configure SPI
    P1SEL |= BIT3 | BIT4 | BIT5;            // P1.3, 4, 5 option select
