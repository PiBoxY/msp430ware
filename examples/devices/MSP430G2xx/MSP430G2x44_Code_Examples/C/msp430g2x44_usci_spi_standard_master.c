//******************************************************************************
//   MSP430G2x44 Demo - USCI_A0, SPI 3-Wire Master multiple byte RX/TX
//
...
//            /|\ |             P1.1|-> Comms LED
//             |  |                 |
//             ---|RST          P3.6|-> Slave Reset (GPIO)
//                |                 |
//                |             P3.4|-> Data Out (UCA0SIMO)
//                |                 |
//       Button ->|P1.3         P3.5|<- Data In (UCA0SOMI)
//   Button LED <-|P1.0             |
//                |             P3.0|-> Serial Clock Out (UCA0CLK)
//                |                 |
//                |             P3.3|-> Slave Chip Select (GPIO)
//
...
#define SLAVE_RST_OUT   P3OUT
#define SLAVE_RST_DIR   P3DIR
